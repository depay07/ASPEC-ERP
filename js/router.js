...
function getTableStructure(tab) {
    var structures = {
        ...
        purchase_orders: '<thead><tr><th style="width:12%">PO#</th><th style="width:15%">납품업체</th><th style="width:15%">EndUser</th><th>품목요약</th><th style="width:10%">총액</th><th style="width:10%">일자</th><th style="width:5%">상태</th><th style="width:10%">송금액</th><th style="width:10%">관리</th></tr></thead>',
